...
/**
 * MouseHandler class extends the abstract class. abstract classes should never
 * be instantiated so here a concrete that can be instantiated
 */
public class MouseHandler extends GLFWCursorPosCallback {
	 ...
	 * 
	 * @param camera
	 *            movements get directed at this camera
	 * @param renderer
	 *            Instance of MastererRenderer to get the right projection
	 *            matrix.
	 * @param config
